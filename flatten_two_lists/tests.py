from flatten_two_lists import flatten_two_lists as f
import unittest
...
class EmptyListsTests(unittest.TestCase):
	...
	def testNoDepth(self):
		expected = ([], [])
		self.assertEqual(f(self.a, self.b, 0), expected)

	def testOneDepth(self):
		expected = ([], [])
		self.assertEqual(f(self.a, self.b, 1), expected)

	def testRandomDepth(self):
		expected = ([], [])
		self.assertEqual(f(self.a, self.b, 195667), expected)

	def testNegativeDepth(self):
		expected = ([], [])
		self.assertEqual(f(self.a, self.b, -345), expected)
...
class SingleElementListsTests(unittest.TestCase):
	...
	def testRandomDepth(self):
		expected = ([1], [2])
		self.assertEqual(f(self.a, self.b, 456756), expected)

	def testNegativeDepth(self):
		expected = ([1], [2])
		self.assertEqual(f(self.a, self.b, -456), expected)
...
class MultiElementListsTests(unittest.TestCase):
	...
	def testRandomDepth(self):
		expected = ([1, 2, 3], [4, 5])
		self.assertEqual(f(self.a, self.b, 456565), expected)

	def testNegativeDepth(self):
		expected = ([1, 2, 3], [4, 5])
		self.assertEqual(f(self.a, self.b, -346), expected)
...
class CombinedElementListsTests(unittest.TestCase):
	...
	def testNoOneElementsNoDepth(self):
		...
		b = [1]
		expected = ([], [1])
		self.assertEqual(f(a, b, 0), expected)

	def testNoOneElementsRandomDepth(self):
		a = []
		b = [1]
		expected = ([], [1])
		self.assertEqual(f(a, b, 456784), expected)

	def testNoOneElementsNegativeDepth(self):
		a = []
		b = [1]
		expected = ([], [1])
		self.assertEqual(f(a, b, -834), expected)
	...
	def testNoMultiElementsRandomDepth(self):
		...
		b = [1, 2, 3]
		expected = ([], [1, 2, 3])
		self.assertEqual(f(a, b, 347658), expected)

	def testNoMultiElementsNegativeDepth(self):
		a = []
		b = [1, 2, 3]
		expected = ([], [1, 2, 3])
		self.assertEqual(f(a, b, -589), expected)
	...
	def testOneMultiElementsRandomDepth(self):
		...
		b = [2, 3]
		expected = ([1], [2, 3])
		self.assertEqual(f(a, b, 456777), expected)

	def testOneMultiElementsNegativeDepth(self):
		a = [1]
		b = [2, 3]
		expected = ([1], [2, 3])
		self.assertEqual(f(a, b, -476), expected)
...
class LayeredListsTests(unittest.TestCase):
	...
	def testOneLayerOneDepth(self):
		...
		b = [4, [5], 6]
		expected = ([1, 2, 3], [4, 5, 6])
		self.assertEqual(f(a, b, 1), expected)

	def testOneLayerRandomDepth(self):
		a = [1, [2], 3]
		b = [4, [5], 6]
		expected = ([1, 2, 3], [4, 5, 6])
		self.assertEqual(f(a, b, 157869), expected)

	def testOneLayerNegativeDepth(self):
		a = [1, [2], 3]
		b = [4, [5], 6]
		expected = ([1, [2], 3], [4, [5], 6])
		self.assertEqual(f(a, b, -577), expected)
	...
	def testMultiLayerRandomDepth(self):
		...
		b = [8, [[9], []], []]
		expected = ([1, 2, 3, 4, 5, 6, 7], [8, 9])
		self.assertEqual(f(a, b, 849633), expected)

	def testMultiLayerNegativeDepth(self):
		a = [1, [2, [3, 4], [5]], 6, [7]]
		b = [8, [[9], []], []]
		expected = ([1, [2, [3, 4], [5]], 6, [7]], [8, [[9], []], []])
		self.assertEqual(f(a, b, -561), expected)
